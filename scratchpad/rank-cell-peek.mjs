...
await send('Page.navigate', { url: 'https://loginsa.cloud/league/nolink/rank/player' }); await sleep(9000)
...
console.log('개인랭킹:'); console.log(await peek('/^[\d,]+전$/'))
console.log('클랜랭킹:'); await send('Page.navigate', { url: 'https://loginsa.cloud/league/nolink/rank/clan' }); await sleep(9000)
