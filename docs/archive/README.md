...
### 세션 기록
`session-ledger/` · `session-2026-09-16.md` · `session-2026-09-17-six-axes.md`

`session-2026-09-16.md` — **육각 축이 왜 지금 모양인지**가 여기 있다.
축 여섯 개가 하루에 다섯 번 바뀐 날이라 실측 숫자와 사장님 말씀을 같이 적어 뒀다.
「퍼짐이 넓다고 좋은 축이 아니다」 같은 함정은 다시 밟기 쉬우니 먼저 읽어라.

`session-2026-09-17-six-axes.md` — ★축을 통째로 바꿋 밤★.
후보 열넷을 실측해 열을 버렸다 — ★무엇을 왜 버렸나★ 가 그 문서의 알맹이다.
축을 또 바꾸려는 사람은 «버린 것» 표부터 보라 — 거기 있는 것은 이미 재 봤고 안 됐다.
