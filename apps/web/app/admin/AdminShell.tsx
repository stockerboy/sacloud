...
const MENU = [
  ...
  /* ★화면 글★ (2026-09-21 사장님: 「이거 내가 관리자 권한으로 수정 할 수 있게 해줘 글」) */
  { href: '/admin/texts', label: '화면글' },
  /*
   * ★공지 쓰기★ (2026-09-21 사장님: 「★관리자 권한으로 공지사항도 쓸 수 있게 해줘★」)
   *
   * ⚠ ★기능은 이미 있었다★ — `createBoard` 가 「공지는 운영자만 작성할 수 있습니다」 로
   *   막고, 공지 카테고리 글은 목록 맨 위에 고정된다. ★들어갈 길만 없었다.★
   *   공지는 카테고리 화면이 따로 없어서(각 목록 위에 붙는다) 내비에서도 빠져 있었다.
   *   그래서 여기 한 줄을 낸다.
   */
