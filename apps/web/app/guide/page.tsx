...
const SECTIONS: readonly Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      li('시즌 1 시작과 동시에 시즌 0의 기록은 초기화됩니다.'),
      p('시즌 1 — 정식 시즌'),
      li('2026년 10월 1일 시작 예정입니다. 참가 신청은 10월 15일까지 받습니다.'),
...
const PIPELINE: readonly PipelineStep[] = [
  {
    ...
    facts: ['수집 주기 10분', '시즌 0 누적 3,492경기', '중복 방지 — 경기 하나에 행 하나'],
  },
  {
    no: '02',
    title: '판별',
  ...
  },
  {
    ...
    title: '리그 분류',
    detail:
      '양 팀의 등록 상태를 보고 IPL · PL · 열산리그 로 나눕니다. 클랜은 한 리그에만 속합니다. 다른 리그에 합류하면 이전 리그 목록에서 빠지되 경기 기록은 그대로 남습니다.',
  ...
  },
  {
    ...
    facts: [
      ...
      '게임영향력 — 팽팽하거나 밀릴 때 따낸 킬 (라운드당 한 번이면 100%)',
      '선짤 — 라운드 첫 킬을 딴 비율',
      '교환율 — 동료가 죽은 직후 5초 안에 그 킬러를 되잡은 비율',
