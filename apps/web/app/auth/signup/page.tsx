  ...
  return (
    ...
    >
      ...
      */}
      <AuthField
        label="서든 닉네임"
        /* ⚠ ★지금 게임에서 쓰는 닉★ 이어야 한다 (2026-09-13 실측). 넥슨은 「지금 그 닉을
           쓰는 사람」을 준다 — 옛 닉이나 우리 화면의 표시 이름을 옮겨 적으면 전부 실패한다.
           고르는 목록은 마이페이지 계정인증에 있다 (여기는 칸이 좁아 안 넣는다) */
        hint="★지금 게임에서 쓰는 닉★ 이어야 합니다 · 비워도 가입되고 나중에 마이페이지에서 할 수 있습니다"
