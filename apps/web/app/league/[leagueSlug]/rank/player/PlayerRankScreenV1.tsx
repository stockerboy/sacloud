...
/**
 * ★★옛 개인랭킹 화면★★ — 2026-09-07 Part 10 ⑤ 에서 v2 로 갈아끼우기 ★직전★ 판.
 *
 * ★지우지 않는다★ (`CLAUDE.md` 1-4). 되돌리려면 `page.tsx` 의 import 를
 * `./PlayerRankScreenV1` 로 바꾸면 된다 — 다른 파일은 안 건드려도 된다.
 *
 * 아래는 그때의 원문 주석 그대로다.
 *
 ...
 */
export default function PlayerRankPageV1({ params }: { params: Promise<{ leagueSlug: string }> }) {
