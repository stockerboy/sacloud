 ...
 *   ⚠ ★★「미러가 더 많이 안다」는 IPL 에서 참이 아니었다★★ (2026-09-04 · 같은 날 재서 고쳤다)
 *     D-034 를 인용해 «미러는 무기·어시스트·헤드샷까지 갖고 있다» 고 적었는데 ★재 보니 틀렸다★ —
 * ```
 * 출처              행수    킬    어시  헤드샷  데미지   무기  무기=0
 * nexon_barracks  40,849  100%   ★0%★  ★0%★   ★0%★   98%   ★79%★
 * 3rd.supply       9,205  100%   ★0%★  ★0%★   ★0%★   98%   ★79%★
 * ```
 *     ★IPL 에서는 셋 다 킬·데스뿐이다.★ 무기도 79% 가 0(=알 수 없음)이다.
 *     ★D-034 는 다른 리그 얘기였다.★ ★인용한 근거는 반드시 그 자리에서 다시 재야 한다.★
 *     ★다행히 최종 규칙이 「좋은 출처」가 아니라 「10명인 쪽」이라 결과는 안 바뀐다.★
 *
 * ```
 * 미러 10명                → ★병영수첩 것을 지운다★
