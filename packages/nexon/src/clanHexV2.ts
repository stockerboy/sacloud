 ...
 *   ```
 *                          0:0     한 팀이 0%   둘 다 있음   판당 라운드
 *     스나싸움              3.1%      16.6%       80.3%
 *     소수싸움              2.0%      21.0%       77.0%
 *     세이브                3.7%      39.7%       56.6%
 *     ②안 (각자 분모)      19.5%      49.8%       30.8%       1~2   ← 못 쓴다
 *     ③안 (일찍 죽은 것만)  0.2%      11.0%       88.8%       6.6
 *     ★④안 (지금)★        0.1%       8.7%       91.2%       7.6   ← 지금 축들 중 제일 낮다
 *     ⑤안 (0킬이면 무조건)  0.0%       6.3%       93.6%       9.0   ← 승률겹침 0.917 로 못 쓴다
 *   ```
 *
 *   ⚠ ★«한 팀이 0%» 를 아예 없앨 수는 없다★ (2026-09-15 밤 사장님: «둘중에 한팀이라도
 *     0인건 안돼»). 한 팀이 그 라운드들을 ★다 이기면★ 상대는 0회다 — 스나싸움도 같다.
 *     할 수 있는 것은 드물게 만드는 것뿐이고, ④안이 지금 여섯 축 중 가장 드물다.
 *
 *   ★맞바꾼 것★: 라운드 승률과의 겹침이 0.552 → **0.829** 로 올랐다.
